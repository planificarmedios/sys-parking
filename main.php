...
// =======================
$fecha_ingreso_db       = date('Y-m-d');
$hora_ingreso_db        = date('H:i:s');
$fecha_ingreso_mostrar  = date('d/m/Y');
$hora_ingreso_mostrar   = date('H:i');
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="" alt=""> 
      ...
      <footer class="main-footer">
        <strong> <a href="" target="_blank">Sistemas Web Soft Engineer Lic. Leandro Nieto</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
