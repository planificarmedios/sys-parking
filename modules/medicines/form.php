...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Agregar Conceptos
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=medicines"> Conceptos y Abonos </a></li>
          ...
          <form role="form" class="form-horizontal" action="modules/medicines/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              <div class="form-group" hidden>
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    ...
                    <input type="text" value='0'class="form-control" id="precio_compra" name="pcompra" autocomplete="off" onKeyPress="return goodchars(event,'0123456789.,',this)">
                  </div>
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label">Importe de Abono</label>
                <div class="col-sm-5">
                  <div class="input-group">
                    <span class="input-group-addon">$.</span>
              ...
              <div class="form-group" hidden>
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" value='pesos' name="unidad" data-placeholder="-- Seleccionar --" autocomplete="off">
                    <option value=""></option>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT id,nombre,precio FROM productos WHERE id='$_GET[id]'") 
                                      or die('error: '.mysqli_error($mysqli));
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Modificar Conceptos y Abonos
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=medicines"> Conceptos y Abonos </a></li>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <div class="input-group">
                    <span class="input-group-addon">$.</span>
                    <input type="text" class="form-control" id="precio" name="pventa" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo format_rupiah($data['precio']); ?>" required>
                  </div>
                </div>
              </div>
