      ...
      <div class="col-md-12">
        <div class="box box-primary">
         ...
         <div class="form-group">
                  ...
                  <a class="btn btn-danger btn-social pull-right" 
                  href='?module=form_clients&form=asoc&id_cliente=<?php echo $id_cliente;?>&anual=si' 
                  title="Agendar Abono Anual" data-toggle="tooltip">
                    <i class="fa fa-calendar"></i> Agendar Abono Anual
                  </a> 
                  
                  <a class="btn btn-success btn-social pull-right" 
                    href='?module=form_clients&form=asoc&id_cliente=<?php echo $id_cliente;?>&anual=no' 
                    title="Agendar Abono" data-toggle="tooltip">
                    <i class="fa fa-calendar"></i> Agendar Abono Mensual
                  </a>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <a class="btn btn-danger btn-social pull-right" href='?module=form_clients&form=asoc&id_cliente=<?php echo $id_cliente;?>' 
               title="Agendar Abono" data-toggle="tooltip">
              <i class="fa fa-calendar"></i> Agendar Abonoxxx
            </a>
          </h1>
...
<div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables2" class="table table-bordered table-striped table-hover">
            ...
            if ($anual == "no") { ?>
              <a data-toggle="tooltip" data-placement="top" title="Agregar Abono Mensual" class="btn btn-success btn-sm" 
                    href="modules/clients/proses.php?act=addabono&precio_venta=<?php echo $precio_venta;?>&id_cliente=<?php echo $id_cliente;?>&codigo=<?php echo $data['id'];?>&anual=<?php echo $anual?>" 
                    onclick="return confirm('estas seguro de agregar <?php echo $data['nombre']; ?> ?');">
                    <i style="color:#fff" class="glyphicon glyphicon-plus"></i>
                    </a>                    
              <?php
              } else { ?>

                    <a data-toggle="tooltip" data-placement="top" title="Agregar Abono Anual" class="btn btn-primary btn-sm" 
                    href="?module=form_clients&form=asocAnual&precio_venta=<?php echo $precio_venta;?>&id_cliente=<?php echo $id_cliente;?>&codigo=<?php echo $data['id'];?>&anual=<?php echo $anual?>" 
                    onclick="">
                    <i style="color:fff" class="glyphicon glyphicon-plus"></i>
                    </a> 
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        action="modules/clients/proses.php?act=addAbonoAnual"
        ...
        >
          ...
          <div class="form-group">
                <label class="col-sm-4 control-label">Frecuencia Facturación</label>
                <div class="col-sm-5">
          ...
          <div class="form-group">
                 <div class="btn-toolbar">
                    ...
                    <a class="btn btn-danger pull-left" 
                      href="?module=form_clients&form=sinAgenda"
                      data-toggle="tooltip">Cancelar
                    </a> 
                </div>
          </div>
